...
namespace ShoppingPrueba.Migrations
{
    ...
    [Migration("20220923070828_PruebaConAzure")]
    partial class PruebaConAzure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingPrueba.Data.Entities.TemporalSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShoppingPrueba.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShoppingPrueba.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingPrueba.Data.Entities.TemporalSale", b =>
                {
                    ...
                    b.HasOne("ShoppingPrueba.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("ShoppingPrueba.Data.Entities.User", b =>
                {
                    b.HasOne("ShoppingPrueba.Data.Entities.City", "City")
                        .WithMany("Users")
